/*
* First condition Check if sc2 is true and MSF and Quantity is not empty
* Second condition Check if sc2 is true and MSF and Quantity is empty
*/
if(input.sc2 = true && row.Monthly_Service_Fee != null && row.sc_Quantity2 != null)
{
	row.sc_Total2=row.Monthly_Service_Fee * row.sc_Quantity2;
}
else if(input.sc2 = true && row.Monthly_Service_Fee == null || row.sc_Quantity2 == null)
{
	row.sc_Total2=0;
}
//
