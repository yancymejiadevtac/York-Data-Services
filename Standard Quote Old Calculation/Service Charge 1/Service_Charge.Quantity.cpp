/*
* First condition Check if sc0 is true and MSF and Quantity is not empty
* Second condition Check if sc0 is true and MSF and Quantity is empty
*/
if(input.sc0 == true && row.Monthly_Service_Fee != null && row.sc_Quantity0 != null)
{
	//Multiply MSF * Qunatity to get the Total Amount
	row.sc_Total0=row.Monthly_Service_Fee * row.sc_Quantity0;
}
else if(input.sc0 == true && row.Monthly_Service_Fee == null || row.sc_Quantity0 == null)
{
	//Default to 0
	row.sc_Total0=0;
}
