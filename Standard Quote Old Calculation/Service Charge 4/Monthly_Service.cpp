...
*/
if(input.sc3 = true && row.Monthly_Service_Fee != null && row.sc_Quantity3 != null)
{
	row.sc_Total3=row.Monthly_Service_Fee * row.sc_Quantity3;
}
else if(input.sc3 = true && row.Monthly_Service_Fee == null || row.sc_Quantity3 == null)
{
	row.sc_Total3=0;
}
/********************************************************
