/*
* First condition Check if sc1 is true and MSF and Quantity is not empty
* Second condition Check if sc1 is true and MSF and Quantity is empty
*/
if(input.sc1 == true && row.Monthly_Service_Fee != null && row.sc_Quantity1 != null)
{
	//Multiply MSF * Qunatity to get the Total Amount
	row.sc_Total1=row.Monthly_Service_Fee * row.sc_Quantity1;
}
else if(input.sc1 == true && row.Monthly_Service_Fee == null || row.sc_Quantity1 == null)
{
	//Default to 0
	row.sc_Total1=0;
}
