...
if(input.sc3 == true)
{
	var_deleted_value = IFNULL(row.sc_Total3,0.00);
}
// 
//
//GLOBAL VARIABLES
	...
	if(input.Add_another_service_2 == true)
	{
		...
		*/
		if(input.Add_another_service_3)
		{
			...
			input.Service_Charges_Sub_Total_4 = monthly_fee4 - var_deleted_value;
			input.Service_Sub_Total_4 = sd_totals4 + IFNULL(input.Carriage_4,0) - var_deleted_value;
		}
	}
}
//
